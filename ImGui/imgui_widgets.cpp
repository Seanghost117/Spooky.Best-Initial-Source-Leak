...
bool ImGui::ColorBarEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
	...
	window->DrawList->AddRectFilledMultiColor(ImVec2(p.x + 1, p.y - 5), ImVec2(p.x + ImGui::GetWindowWidth() / 2, p.y - 3), ImColor(250, 25, 25), ImColor(250, 25, 70), ImColor(250, 25, 70), ImColor(250, 25, 25));
	window->DrawList->AddRectFilledMultiColor(ImVec2(p.x + ImGui::GetWindowWidth() / 2, p.y - 5), ImVec2(p.x + ImGui::GetWindowWidth() - 1, p.y - 3), ImColor(250, 25, 70), ImColor(255, 61, 103), ImColor(255, 61, 103), ImColor(250, 25, 70));
...
bool ImGui::SelectedTabEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
	...
	window->DrawList->AddRect(bb.Min + ImVec2(-1.f, 1.f), bb.Max - ImVec2(0.f, 54.f), outerBorderColor, 0.f, NULL, 1.f);
	window->DrawList->AddRect(bb.Min - ImVec2(1.f, 0.f), bb.Max - ImVec2(0.5f, 54.f), innerBorderColor, 0.f, NULL, 1.f);

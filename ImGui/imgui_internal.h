...
struct ImGuiPopupRef;               // Stohnly for current popup stack
...
struct ImGuiNextWindowData
{
	...
	void    Clear()
	{
		PosCond = SizeCond = ContentSizeCond = CollapsedCond = SizeConstraintCond = FocusCond = BgAlphaVal = 0;
	}
};
...
struct IMGUI_API ImGuiWindowTempData
{
	...
	bool                    ButtonRepeat;// Current layer, 0..31 (we currently only use 0..1)
...
struct IMGUI_API ImGuiWindow
{
	...
	ImVec2                  SizeFull;
	ImVec2                  SizeFullAtLastBegin;// Size when non collapsed
	ImVec2                  SizeContents;

...
namespace Mystic
{
	...
	namespace ENTITY
	{
		...
		inline NativeVector3 GET_ENTITY_COORDS(Entity entity, bool alive) { return invoke<Vector3>(0x3FEF770D40960D5A, entity, alive); } // 0x3FEF770D40960D5A 0x1647F1CB
		...
		inline void SET_ENTITY_COORDS(Entity entity, NativeVector3 coords, bool xAxis, bool yAxis, bool zAxis, bool clearArea) { invoke<Void>(0x06843DA7060A026B, entity, coords, xAxis, yAxis, zAxis, clearArea); } // 0x06843DA7060A026B 0xDF70B41B
	...
	namespace GRAPHICS
	{
		...
		inline BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_HUD_COMPONENT(int hudComponent, char* functionName) { return invoke<BOOL>(0x98C494FD5BDFBFD5, hudComponent, functionName); } // 0x98C494FD5BDFBFD5 0x5D66CE1E
		...
		inline BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_N(char* functionName) { return invoke<BOOL>(0xAB58C27C2E6123C6, functionName); } // 0xAB58C27C2E6123C6 0xF6015178
		inline BOOL _BEGIN_SCALEFORM_MOVIE_METHOD_V(char* functionName) { return invoke<BOOL>(0xB9449845F73F5E9C, functionName); } // 0xB9449845F73F5E9C 0x5E219B67
		...
		inline void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(float value) { invoke<Void>(0xD69736AAE04DB51A, value); } // 0xD69736AAE04DB51A 0x9A01FFDA
		inline void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(BOOL value) { invoke<Void>(0xC58424BA936EB458, value); } // 0xC58424BA936EB458 0x0D4AE8CB
	...
	namespace NETWORK
	{
		...
		inline BOOL NETWORK_REPORT_PLAYER() { return invoke<BOOL>(0x472841A026D26D8B); } // 0x472841A026D26D8B 
	...
	namespace PATHFIND
	{
		...
		inline Any GET_CLOSEST_ROAD(const NativeVector3& pos, float p3, int p4, NativeVector3* p5, NativeVector3* p6, int* p7, int* p8, float* p9, bool p10) { return invoke<Any>(0x132F52BBA570FE92, pos, p3, p4, p5, p6, p7, p8, p9, p10); } // 0x132F52BBA570FE92 0x567B0E11
	...
	namespace PLAYER
	{
		...
		inline char* GET_PLAYERS_NAME(Player player) { return invoke<char*>(0x6D0DE6A7B5DA71F8, player); } // 0x6D0DE6A7B5DA71F8 0x406B4B20
	...
	namespace STATS
	{
		...
		inline void SET_LUCK(Any p0) { invoke<Void>(0x930F504203F561C9, p0); } // 0x930F504203F561C9 
	...
	namespace STREAMING
	{
		...
		inline void REQUEST_COLLISION_AT_COORD(const NativeVector3& pos) { invoke<Void>(0x07503F7948F491A7, pos); } // 0x07503F7948F491A7 0xCD9805E7
		...
		inline void REQUEST_ADDITIONAL_COLLISION_AT_COORD(const NativeVector3& pos) { invoke<Void>(0xC9156DC11411A9EA, pos); } // 0xC9156DC11411A9EA 0xC2CC1DF2
	...
	namespace VEHICLE
	{
		...
		inline Vehicle CREATE_VEHICLE(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); } // 0xAF35D0D2583051B0 0xDD75460A
		...
		inline Any GET_VEHICLE_XENON_COLOUR(Any p0) { return invoke<Any>(0x3DFF319A831E0CDB, p0); } // EE21293DAD47C9513D53892    
		inline void SET_VEHICLE_XENON_COLOUR(Any p0, int p1) { invoke<Void>(0xE41033B25D003A07, p0, p1); }
	...
	namespace TEST
	{
		inline void _SET_INTERIOR_COATING_COLOR(Vehicle vehicle, int id) { invoke<Void>(0xF40DD601A65F7F19, vehicle, id); }
		inline void _SET_INTERIOR_DASH_LIGHT_COLOR(Vehicle vehicle, int id) { invoke<Void>(0x6089CDF6A57F326C, vehicle, id); }
		inline char* _GET_VEHICLE_MOD_COLOR_1_TEXT_LABEL(Vehicle vehicle, BOOL p1) { return invoke<char*>(0xB45085B721EFD38C, vehicle, p1); } // 0xB45085B721EFD38C 0x0237C1134582FE45
		inline char* _GET_VEHICLE_MOD_COLOR_2_TEXT_LABEL(Vehicle vehicle) { return invoke<char*>(0x4967A516ED23A5A1, vehicle); } // 0x4967A516ED23A5A1 0x85B7E903408ADED3
	}
